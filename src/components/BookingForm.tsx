...
const BookingForm: React.FC<BookingFormProps> = ({ formData, onChange, onQuantityChange, language }) => {
  const t = translations[language].bookingForm;
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8 space-y-8">
              ...
              >
                <div className="flex items-center gap-4 w-full sm:w-auto">
                   ...
                   <div>
                     ...
                     {/* Use translated description instead of the one from constants */}
                     <p className="text-sm text-gray-500">{t.bagDescriptions[size]}</p>
      ...
      <div className="space-y-4 border-t border-gray-100 pt-6">
        <label className="block text-sm font-bold text-gray-700 uppercase tracking-wide">
          {t.section3} <span className="text-red-500 font-normal normal-case ml-1">{t.required}</span>
        </label>
        <div className="grid grid-cols-1 gap-4">
