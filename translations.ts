...
export const TRANSLATIONS: Record<Language, any> = {
  en: {
    ...
    booking: {
      ...
      fridayDisclaimer: 'Ps. On fridays we close between 11.30am to 13.00 pm',
  ...
  it: {
    ...
    booking: {
      ...
      fridayDisclaimer: 'Ps. Il venerdì siamo chiusi dalle 11:30 alle 13:00',
      ...
      perBag: 'a bagaglio',
      perDay: 'giorno',
      dropOff: 'Data Ritiro (Drop-off)',
      dropOffTime: 'Ora Ritiro (Drop-off)',
      pickUp: 'Data Consegna (Pick-up)',
      pickUpTime: 'Ora Consegna (Pick-up)',
