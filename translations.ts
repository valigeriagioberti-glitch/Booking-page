...
export const TRANSLATIONS: Record<Language, any> = {
  en: {
    ...
    booking: {
      ...
      small: 'Small',
      smallDesc: 'Small suitcase or backpack. Max height: 55cm / 20 inches.',
      medium: 'Medium',
      mediumDesc: 'A medium suitcase. Max height: 70cm / 27 inches.',
      large: 'Large',
      largeDesc: 'Anything larger than 70cm / 27 inches.',
      perDay: 'day',
  ...
  it: {
    ...
    booking: {
      ...
      small: 'Piccolo',
      smallDesc: 'Valigia piccola o zaino. Altezza massima: 55 cm / 20 pollici.',
      medium: 'Medio',
      mediumDesc: 'Una valigia media. Altezza massima: 70 cm / 27 pollici.',
      large: 'Grande',
      largeDesc: 'Qualsiasi cosa più grande di 70 cm / 27 pollici.',
      perDay: 'giorno',
